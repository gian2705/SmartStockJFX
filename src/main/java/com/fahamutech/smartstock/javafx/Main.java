package com.fahamutech.smartstock.javafx;

import com.fahamutech.smartstock.javafx.Ui.BaseUIComponents;
import com.fahamutech.smartstock.javafx.provider.BaseDataClass;
import com.fahamutech.smartstock.javafx.provider.Resources;
...
//                                    SaleCategoryData.getTotalTraSaleOfDayOfCashier(com.fahamutech.smartstock.databasemodel.Main.currentUserName);
...
//
//                            //call admin stage
//                            MainStage.stageAdmin.setTitle("Lb Pharmacy-" + com.fahamutech.smartstock.databasemodel.Main.currentUserName);
//
//                            stageLogIn.hide();
...
//                                    .getTotalTraSaleOfDayOfCashier(com.fahamutech.smartstock.databasemodel.Main.currentUserName);
...
//                            MainStage.stageUser.setTitle("Lb Pharmacy-" + com.fahamutech.smartstock.databasemodel.Main.currentUserName);
//                            stageLogIn.hide();
//                            usernameTextField.clear();
//                            passwordField.clear();
