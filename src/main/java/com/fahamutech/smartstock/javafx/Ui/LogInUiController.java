...
import com.fahamutech.smartstock.javafx.dataFactory.LogInStageData;
...
//        topButton.addEventHandler(MOUSE_PRESSED, e -> drawerStack.toggle(topDrawer));
        ...
        try {
            ...
            leftDrawer.setSidePane((VBox) FXMLLoader.load(getClass().getResource("com/fahamutech/smartstock/javafx/provider/fxmls/logInLeftDrawer.fxml")));
